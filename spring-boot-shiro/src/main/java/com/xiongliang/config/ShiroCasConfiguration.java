...
public class ShiroCasConfiguration {
    ...
    // CasServerUrlPrefix
    public static final String casServerUrlPrefix = "http://182.61.10.117:8080/cas";
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix = "http://localhost:8086/shiro";
    ...
    public CasShiroRealm myShiroCasRealm(EhCacheManager cacheManager) {
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(CasShiroRealm myShiroCasRealm) {
